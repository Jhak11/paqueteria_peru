...
import { LayoutDashboard, Package, Users, Building2, Truck, LogOut, FileText, UserPlus, MapPin, DollarSign } from 'lucide-react';
...
const sidebarItems = [
    ...
    { name: 'Tarifas', href: '/admin/tarifas', icon: DollarSign }, // Added Tarifas
    { name: 'Empleados', href: '/admin/empleados', icon: UserPlus },
    { name: 'Agencias', href: '/admin/agencias', icon: MapPin }, // Added Agencias
