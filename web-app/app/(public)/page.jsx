...
export default function TrackingPage() {
    ...
    return (<div className="min-h-[80vh] flex flex-col items-center">
            ...
            <section className="w-full bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <div className="bg-white p-2 rounded-2xl shadow-xl max-w-2xl mx-auto transform transition-all hover:scale-[1.01]">
                        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2">
                            <div className="relative flex-grow">
                                ...
                                <input type="text" className="w-full pl-11 pr-4 py-4 rounded-xl border border-transparent bg-gray-50 text-gray-900 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all text-lg" placeholder="Número de seguimiento (Ej: PE-675-630)" value={code} onChange={(e) => setCode(e.target.value)}/>
                            </div>
                            <button type="submit" disabled={loading} className="bg-blue-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 transition-colors font-semibold text-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-blue-200">
                    ...
                    {error && (<div className="mt-6 bg-red-500/10 border border-red-500/20 rounded-xl p-4 max-w-lg mx-auto backdrop-blur-sm animate-fade-in-up">
            ...
            {/* Results Section */}
            {data && (<section className="w-full max-w-5xl mx-auto px-4 -mt-10 relative z-20 pb-20 animate-fade-in-up">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 min-h-[400px]">
                                ...
                                <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 before:to-transparent">
                                    ...
                                    {data.historial.map((evento, index) => (<div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                            {/* Icon/Dot */}
                                            <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-white bg-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                                                {index === 0 ? (<div className="w-3 h-3 bg-blue-600 rounded-full animate-pulse"></div>) : (<div className="w-3 h-3 bg-gray-300 rounded-full"></div>)}
                                            </div>
                                            ...
                                            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    {evento.ubicacion && (<p className="text-xs text-gray-400 flex items-center gap-1 mt-2 pt-2 border-t border-gray-50">
                                    ...
                                    {data.historial.length === 0 && (<div className="text-center py-10 text-gray-400">
