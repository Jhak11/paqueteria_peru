...
export default function AgenciasPage() {
    ...
    return (<div className="max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <Link href="/admin/agencias/nuevo" // This page will need to be created if not exists
     className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
            ...
            <div className="relative">
                ...
                <input type="text" placeholder="Buscar agencia por nombre o ciudad..." className="pl-10 w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
            </div>
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {loading ? (<tr>
                                ...
                                </tr>) : filteredAgencias.length === 0 ? (<tr>
                                    <td colSpan={5} className="px-6 py-8 text-center text-gray-500">
                                        No se encontraron agencias
                                    </td>
                                </tr>) : (filteredAgencias.map((agencia) => (<tr key={agencia.id_agencia} className="hover:bg-gray-50 transition">
