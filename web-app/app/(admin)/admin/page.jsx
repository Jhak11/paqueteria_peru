...
async function getDashboardData() {
    try {
        ...
        const [recentEnvios] = await pool.query(`
            SELECT 
        ...
        const [delayedEnvios] = await pool.query(`
            SELECT 
                e.codigo_seguimiento, 
                es.nombre as estado
            FROM envios e
...
export default async function Home() {
    ...
    return (<div className="mx-auto max-w-7xl">
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <Link href="/admin/agencias" className="flex items-center gap-3 p-4 bg-white rounded-lg shadow hover:shadow-md transition border border-transparent hover:border-orange-200">
                ...
                <Link href="/admin/empresas/nuevo" className="flex items-center gap-3 p-4 bg-white rounded-lg shadow hover:shadow-md transition border border-transparent hover:border-blue-200">
                ...
                <Link href="/admin/empleados/nuevo" className="flex items-center gap-3 p-4 bg-white rounded-lg shadow hover:shadow-md transition border border-transparent hover:border-green-200">
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="rounded-lg bg-white p-6 shadow">
                    ...
                    <div className="flow-root">
                        <ul role="list" className="-my-5 divide-y divide-gray-200">
                            {data.recent.length === 0 ? (<p className="py-4 text-sm text-gray-500">No hay actividad reciente.</p>) : (data.recent.map((envio) => (<li key={envio.codigo_seguimiento} className="py-4">
                ...
                <div className="rounded-lg bg-white p-6 shadow">
                    ...
                    <div className="mt-4 space-y-2">
                        {data.delayed.length === 0 ? (<p className="text-sm text-gray-500">No hay alertas activas.</p>) : (data.delayed.map((envio) => (<div key={envio.codigo_seguimiento} className="w-full bg-red-50 rounded border border-red-100 flex items-center p-3">
