...
export async function DELETE(request, { params }) {
    try {
        ...
        if (error.code === 'ER_ROW_IS_REFERENCED_2') {
            return NextResponse.json({ error: 'No se puede eliminar el vehículo porque tiene viajes o historial asociado. Intente cambiar su estado a "Retirado".' }, { status: 409 });
        }
